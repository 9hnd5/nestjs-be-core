import { Body, Controller, Delete, Get, Inject, Injectable, Param, Post, Put, Scope, UseInterceptors } from "@nestjs/common";
...
import { Mediator } from "modules/cqrs/mediator.service";

...
const staticRequestHandlerMap: Map<Type<CQRSRequest<any>>, Type<AbstractRequestHandler<any, CQRSRequest<any>>>[]> = new Map();
...
export function RequestHandler(requestType: Type<CQRSRequest<any>>, scopeOptions?: ScopeOptions): ClassDecorator {
  return (target: Function): void => {
    ...
    staticRequestHandlerMap.set(requestType, [...requestHandlerTypes, target as Type<AbstractRequestHandler<any, CQRSRequest<any>>>]);

    Injectable(scopeOptions)(target);
  };
}

export function getRequestHandlerType(requestType: Type<CQRSRequest<any>>): Type<AbstractRequestHandler<CQRSRequest<any>, any>>[] {
